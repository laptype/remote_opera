...
def parse_args():
    ...
    parser.add_argument('--out', default="../test_result/eval.pkl", help='output result file in pickle format')
    parser.add_argument(
        '--fuse-conv-bn',
        action='store_true',
...
def main():
    ...
    if args.work_dir is not None and rank == 0:
        mmcv.mkdir_or_exist(osp.abspath(cfg.test_work_dir))
        timestamp = time.strftime('%Y%m%d_%H%M%S', time.localtime())
        json_file = osp.join(cfg.test_work_dir, f'eval_{timestamp}.json')
