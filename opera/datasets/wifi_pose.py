...
class WifiPoseDataset(dataset):
    ...
    def evaluate(self,
        ...
        for i in range(len(results)):
            ...
            for label in range(len(det_keypoints)):
                ...
                mpjpe_3d = self.calc_mpjpe(gt_keypoints, kpt_pred, i, root = [5,7])
    ...
    def calc_mpjpe(self, real, pred, no, root=0):
        ...
        #np.save('/home/yankangwei/opera-main/result/pose_pred/result_%i.npy' %no, new_pred)
        #np.save('/home/yankangwei/opera-main/result/pose_gt/gt_%i.npy' %no, real)
