...
model = dict(
    ...
    bbox_head=dict(
        ...
        loss_trans=dict(type='mmdet.MSELoss', loss_weight=40.0),
        loss_trans_rpn=dict(type='mmdet.MSELoss', loss_weight=40.0),
        loss_trans_refine=dict(type='mmdet.MSELoss', loss_weight=40.0),
    ...
    train_cfg=dict(
        assigner=dict(
            ...
            trans_cost=dict(type='opera.MSECost', weight=10.0),
