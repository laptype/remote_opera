_base_ = [
    '../_base_/datasets/wifi_mesh.py', '../_base_/default_runtime.py'
]
model = dict(
    type='opera.PETR',
    backbone=dict(
...
work_dir = '/home/qianbo/git/opera-version1/results/four_cards_loss_cls_10'
# resume_from = '/home/qianbo/git/opera-version1/results/four_cards_baseline/latest.pth'