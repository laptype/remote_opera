...
model = dict(
    ...
    bbox_head=dict(
        ...
        loss_trans=dict(type='mmdet.MSELoss', loss_weight=100.0),
        loss_trans_rpn=dict(type='mmdet.MSELoss', loss_weight=100.0),
        loss_trans_refine=dict(type='mmdet.MSELoss', loss_weight=100.0),
    ...
    train_cfg=dict(
        assigner=dict(
            ...
            trans_cost=dict(type='opera.MSECost', weight=100.0),
...
# work_dir = '/home/qianbo/git/opera-version2/results/four_cards_cam_trans'
work_dir = f'/home/wangpengcheng/tmp/remote_opera/results/four_cards_cam_trans_[{config_tag}]'
test_work_dir = f'/home/wangpengcheng/tmp/remote_opera/test_result/four_cards_cam_trans_[{config_tag}]'